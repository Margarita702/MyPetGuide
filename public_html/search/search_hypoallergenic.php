...
<head>
  ...
  <title>Search Hypoallergenic Animals - MyPetGuide</title>
...
<main class="section">
  ...
  <h1 class="h1" style="font-size:38px;">Hypoallergenic Animals</h1>
    <p class="sub">Take a look at the hypoallergenic animals!</p>

    <div class="container" style="grid-template-columns:1fr;">
      <div class="container">
        <h3>Press the button to see the hypoallergenic animals.</h3>
