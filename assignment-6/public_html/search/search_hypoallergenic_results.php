...
<head>
  ...
  <title>Hypoallergenic Animals - Results</title>
...
<main class="container" style="padding:50px 20px 80px;">
  <a href="search_hypoallergenic.php" class="back-home">← Back to Search</a>
    ...
    <table border="1" cellpadding="10" cellspacing="0" style="margin-top:25px; width:100%; border-collapse:collapse;">
      ...
      <?php while($row = mysqli_fetch_assoc($result)): ?>
        <tr>
          ...
          <td><a href="search_hypoallergenic_detail.php?id=<?= $row['animal_id'] ?>" class="gradlink">View</a></td>
        </tr>
      <?php endwhile; ?>
    </table>
  <?php else: ?>
    <p>No hypoallergenic animals found.</p>
  <?php endif; ?>
